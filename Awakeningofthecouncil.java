...
public class Awakeningofthecouncil extends JComponent implements MouseListener {
	...
	public void precmdcen(Graphics g){
		...
		g.drawString("347 steps into the light ", 25, 70);
		g.drawString("He steps into a large room, surrounded by windows", 25, 80);
		g.drawString("347: What the f*$# happened last night?!", 25, 100);
		g.drawString("???: Good, you're up.", 25, 110);
		g.drawString("The feminine voice echoed through a dark hallway,", 25, 130);
		g.drawString("347 turned to face it", 25, 140);
		g.drawString("???: I was starting to worry, ", 25, 160);
